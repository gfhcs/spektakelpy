...
TBuiltin.cancellation_error = TBuiltin("CancellationError", [TBuiltin.exception], VException)
...
TBuiltin.continue_error = TBuiltin("ContinueError", [TBuiltin.jump_error], VContinueError)
